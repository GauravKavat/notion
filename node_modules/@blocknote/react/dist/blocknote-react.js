import U, { createContext as Ot, useContext as It, useEffect as T, useMemo as H, useState as v, useCallback as S, useRef as pe, forwardRef as Gn, useImperativeHandle as $n } from "react";
import { useFloating as Nt, useTransitionStyles as Dt, useDismiss as qn, useInteractions as Yn, offset as J, flip as le, shift as Kn, size as At } from "@floating-ui/react";
import { formatKeyboardShortcut as ke, checkBlockIsFileBlock as ae, checkBlockIsFileBlockWithPlaceholder as ce, filenameFromURL as kt, checkBlockHasDefaultProp as Ae, checkBlockTypeHasDefaultProp as ie, checkBlockIsFileBlockWithPreview as Xn, getDefaultSlashMenuItems as Jn, filterSuggestionItems as Qn, getDefaultEmojiPickerItems as eo, mergeCSSClasses as ze, inheritedProps as to, camelToDataKebab as Zt, createStronglyTypedTiptapNode as Ut, propsToAttributes as Wt, getParseRules as no, wrapInBlockStructure as oo, getBlockFromPos as ro, applyNonSelectableBlockFix as io, createInternalBlockSpec as lo, audioParse as ao, audioBlockConfig as co, fileParse as so, fileBlockConfig as uo, imageParse as fo, imageBlockConfig as go, videoParse as mo, videoBlockConfig as ho, BlockNoteEditor as bo, addInlineContentKeyboardShortcuts as po, getInlineContentParseRules as vo, nodeToCustomInlineContent as yt, addInlineContentAttributes as xo, inlineContentToNodes as Co, createInternalInlineContentSpec as ko, stylePropsToAttributes as yo, getStyleParseRules as wo, addStyleAttributes as jo, createInternalStyleSpec as Ho } from "@blocknote/core";
import So, { createPortal as zt, flushSync as Gt } from "react-dom";
import { NodeViewWrapper as $t, ReactNodeViewRenderer as qt, NodeViewContent as Yt, Mark as Mo } from "@tiptap/react";
const Kt = Ot(void 0);
function W(e) {
  return It(Kt);
}
...
function _o() {
  if (wt) return oe;
  wt = 1;
  var e = U, t = Symbol.for("react.element"), n = Symbol.for("react.fragment"), o = Object.prototype.hasOwnProperty, i = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, a = { key: !0, ref: !0, __self: !0, __source: !0 };
  function c(u, d, s) {
    var m, g = {}, h = null, x = null;
    s !== void 0 && (h = "" + s), d.key !== void 0 && (h = "" + d.key), d.ref !== void 0 && (x = d.ref);
    for (m in d) o.call(d, m) && !a.hasOwnProperty(m) && (g[m] = d[m]);
    if (u && u.defaultProps) for (m in d = u.defaultProps, d) g[m] === void 0 && (g[m] = d[m]);
    return { $$typeof: t, type: u, key: h, ref: x, props: g, _owner: i.current };
  }
...
function Eo() {
  return jt || (jt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function G(l, f, b) {
      {
        var p = _.ReactDebugCurrentFrame, E = p.getStackAddendum();
        E !== "" && (f += "%s", b = b.concat([E]));
        var R = b.map(function(j) {
          return String(j);
        });
        R.unshift("Warning: " + f), Function.prototype.apply.call(console[l], console, R);
      }
    }
    var He = !1, Se = !1, se = !1, Me = !1, _e = !1, ue;
    ue = Symbol.for("react.module.reference");
    function Ee(l) {
      return !!(typeof l == "string" || typeof l == "function" || l === o || l === a || _e || l === i || l === s || l === m || Me || l === x || He || Se || se || typeof l == "object" && l !== null && (l.$$typeof === h || l.$$typeof === g || l.$$typeof === c || l.$$typeof === u || l.$$typeof === d || // This needs to include all possible module reference object
    ...
    function Z(l) {
      ...
      if (typeof l == "object")
        switch (l.$$typeof) {
          ...
          case d:
            return vn(l, l.render, "ForwardRef");
          case g:
            var p = l.displayName || null;
            return p !== null ? p : Z(l.type) || "Memo";
          case h: {
            var E = l, R = E._payload, j = E._init;
            try {
              return Z(j(R));
            } catch {
              return null;
    ...
    var $ = Object.assign, ee = 0, Qe, et, tt, nt, ot, rt, it;
    function lt() {
    }
    ...
    var Ve = _.ReactCurrentDispatcher, Te;
    function de(l, f, b) {
      {
        if (Te === void 0)
          try {
...
` + Te + l;
    ...
    function at(l, f) {
      ...
      var R;
      R = Ve.current, Ve.current = null, xn();
      try {
        if (f) {
          var j = function() {
            throw Error();
        ...
        if (N && p && typeof N.stack == "string") {
          for (var k = N.stack.split(`
`), I = p.stack.split(`
`), P = k.length - 1, O = I.length - 1; P >= 1 && O >= 0 && k[P] !== I[O]; )
            O--;
          for (; P >= 1 && O >= 0; P--, O--)
            if (k[P] !== I[O]) {
              if (P !== 1 || O !== 1)
...
` + k[P].replace(" at new ", " at ");
                    return l.displayName && A.includes("<anonymous>") && (A = A.replace("<anonymous>", l.displayName)), typeof l == "function" && fe.set(l, A), A;
                  }
                while (P >= 1 && O >= 0);
              break;
            }
        ...
        Le = !1, Ve.current = R, Cn(), Error.prepareStackTrace = E;
      }
      var X = l ? l.displayName || l.name : "", q = X ? de(X) : "";
      return typeof l == "function" && fe.set(l, q), q;
    }
    function yn(l, f, b) {
      return at(l, !1);
    }
      ...
      if (typeof l == "object")
        switch (l.$$typeof) {
          case d:
            return yn(l.render);
          case g:
            return ge(l.type, f, b);
          case h: {
            var p = l, E = p._payload, R = p._init;
            try {
              return ge(R(E), f, b);
            } catch {
            }
    ...
    var te = Object.prototype.hasOwnProperty, ct = {}, st = _.ReactDebugCurrentFrame;
    function me(l) {
      if (l) {
        var f = l._owner, b = ge(l.type, l._source, f ? f.type : null);
        st.setExtraStackFrame(b);
      } else
        st.setExtraStackFrame(null);
    }
    function jn(l, f, b, p, E) {
      {
          ...
          if (R(l, j)) {
            ...
            try {
              if (typeof l[j] != "function") {
                var I = Error((p || "React class") + ": " + b + " type `" + j + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof l[j] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw I.name = "Invariant Violation", I;
              }
              k = l[j](f, j, p, b, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (P) {
              k = P;
            }
            k && !(k instanceof Error) && (me(E), F("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", p || "React class", b, j, typeof k), me(null)), k instanceof Error && !(k.message in ct) && (ct[k.message] = !0, me(E), F("Failed %s type: %s", b, k.message), me(null));
          }
      }
    }
    ...
    function dt(l) {
      if (Mn(l))
        return F("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Sn(l)), ut(l);
    }
    var ne = _.ReactCurrentOwner, _n = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Tn(l, f) {
      if (typeof l.ref == "string" && ne.current && f && ne.current.stateNode !== f) {
        var b = Z(ne.current.type);
        Be[b] || (F('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', Z(ne.current.type), l.ref), Be[b] = !0);
      }
    }
    function Ln(l, f) {
      {
        var b = function() {
          ft || (ft = !0, F("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", f));
        };
    ...
    function Rn(l, f) {
      {
        var b = function() {
          gt || (gt = !0, F("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", f));
        };
    ...
    function Pn(l, f, b, p, E) {
      {
        var R, j = {}, k = null, I = null;
        b !== void 0 && (dt(b), k = "" + b), Vn(f) && (dt(f.key), k = "" + f.key), En(f) && (I = f.ref, Tn(f, E));
        for (R in f)
          te.call(f, R) && !_n.hasOwnProperty(R) && (j[R] = f[R]);
        if (l && l.defaultProps) {
        ...
        if (k || I) {
          var O = typeof l == "function" ? l.displayName || l.name || "Unknown" : l;
          k && Ln(j, O), I && Rn(j, O);
        }
        return Bn(l, k, I, E, p, ne.current, j);
      }
    }
    var Pe = _.ReactCurrentOwner, mt = _.ReactDebugCurrentFrame;
    function K(l) {
      if (l) {
        var f = l._owner, b = ge(l.type, l._source, f ? f.type : null);
    ...
    function pt(l, f) {
      {
        ...
        bt[b] = !0;
        var p = "";
        l && l._owner && l._owner !== Pe.current && (p = " It was passed a child from " + Z(l._owner.type) + "."), K(l), F('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', b, p), K(null);
      }
    }
    function vt(l, f) {
      {
        ...
        if (Re(l))
          ...
          if (typeof E == "function" && E !== l.entries)
            for (var R = E.call(l), j; !(j = R.next()).done; )
              Oe(j.value) && pt(j.value, f);
        }
      }
    }
    function In(l) {
    ...
    function Nn(l) {
      {
        for (var f = Object.keys(l.props), b = 0; b < f.length; b++) {
          var p = f[b];
          if (p !== "children" && p !== "key") {
            K(l), F("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", p), K(null);
            break;
          }
        }
        l.ref !== null && (K(l), F("Invalid attribute `ref` supplied to `React.Fragment`."), K(null));
      }
    }
    var xt = {};
    function Ct(l, f, b, p, E, R) {
      {
        var j = Ee(l);
        if (!j) {
          var k = "";
          ...
          I ? k += I : k += ht();
          var P;
          l === null ? P = "null" : Re(l) ? P = "array" : l !== void 0 && l.$$typeof === t ? (P = "<" + (Z(l.type) || "Unknown") + " />", k = " Did you accidentally export a JSX literal instead of a component?") : P = typeof l, F("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", P, k);
        }
        var O = Pn(l, f, b, E, R);
        if (O == null)
          return O;
        ...
        if (te.call(f, "key")) {
          var q = Z(l), N = Object.keys(f).filter(function(zn) {
            return zn !== "key";
          }), Ie = N.length > 0 ? "{key: someKey, " + N.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!xt[q + Ie]) {
            var Wn = N.length > 0 ? "{" + N.join(": ..., ") + ": ...}" : "{}";
            F(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, Ie, q, Wn, q), xt[q + Ie] = !0;
          }
        }
        return l === o ? Nn(O) : In(O), O;
      }
    }
    function Dn(l, f, b) {
      return Ct(l, f, b, !0);
    ...
    var Zn = An, Un = Dn;
    re.Fragment = o, re.jsx = Zn, re.jsxs = Un;
  }()), re;
}
process.env.NODE_ENV === "production" ? Ze.exports = _o() : Ze.exports = Eo();
var r = Ze.exports;
function w(e) {
  const t = W();
  if (!(t != null && t.editor))
...
function Q(e, t, n, o) {
  const { refs: i, update: a, context: c, floatingStyles: u } = Nt({
    open: e,
    ...o
  }), { isMounted: d, styles: s } = Dt(c), m = qn(c), { getReferenceProps: g, getFloatingProps: h } = Yn([m]);
  return T(() => {
    a();
  }, [t, a]), T(() => {
...
var Xt = {
  ...
  style: void 0,
  attr: void 0
}, Ht = U.createContext && /* @__PURE__ */ U.createContext(Xt), Lo = ["attr", "size", "title"];
function Ro(e, t) {
  if (e == null) return {};
  var n = Bo(e, t), o, i;
...
function xe(e) {
  for (var t = 1; t < arguments.length; t++) {
    ...
    t % 2 ? St(Object(n), !0).forEach(function(o) {
      Po(e, o, n[o]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n)) : St(Object(n)).forEach(function(o) {
...
function Po(e, t, n) {
  return t = Fo(t), t in e ? Object.defineProperty(e, t, { value: n, enumerable: !0, configurable: !0, writable: !0 }) : e[t] = n, e;
}
function Fo(e) {
  var t = Oo(e, "string");
...
function Jt(e) {
  return e && e.map((t, n) => /* @__PURE__ */ U.createElement(t.tag, xe({
    key: n
  }, t.attr), Jt(t.child)));
}
function y(e) {
  return (t) => /* @__PURE__ */ U.createElement(Io, ve({
    attr: xe({}, e.attr)
  }, t), Jt(e.child));
}
function Io(e) {
  var t = (n) => {
    var {
      ...
      size: i,
      title: a
    } = e, c = Ro(e, Lo), u = i || n.size || "1em", d;
    return n.className && (d = n.className), e.className && (d = (d ? d + " " : "") + e.className), /* @__PURE__ */ U.createElement("svg", ve({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, n.attr, o, c, {
  ...
  return Ht !== void 0 ? /* @__PURE__ */ U.createElement(Ht.Consumer, null, (n) => t(n)) : t(Xt);
}
function No(e) {
...
const he = (e) => {
  ...
  z(() => {
    i && u(e.basicTextStyle in o.getActiveStyles());
  }, o);
  const d = (g) => {
    if (o.focus(), !!i) {
  ...
  if (!H(() => i ? !!a.find((g) => g.content !== void 0) : !1, [i, a]) || !o.isEditable)
    return null;
  const m = lr[e.basicTextStyle];
  ...
  const t = e.textColor || "default", n = e.backgroundColor || "default", o = e.size || 16, i = H(
    () => ({
      pointerEvents: "none",
  ...
  const t = C(), n = M(), o = () => e.text ? /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
    /* @__PURE__ */ r.jsx(t.Generic.Menu.Label, { children: n.color_picker.text_title }),
    Et.map((a) => /* @__PURE__ */ r.jsx(
      t.Generic.Menu.Item,
      {
        onClick: () => {
  ...
  ] }) : null, i = () => e.background ? /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
...
const cr = () => {
  const e = C(), t = M(), n = w(), o = Vt("text", n), i = Vt("background", n), a = D(n), [c, u] = v(
    o && n.getActiveStyles().textColor || "default"
  ), [d, s] = v(
    i && n.getActiveStyles().backgroundColor || "default"
  );
  z(() => {
    o && u(n.getActiveStyles().textColor || "default"), i && s(
  ...
  const m = S(
    (x) => {
      ...
      x === "default" ? n.removeStyles({ textColor: x }) : n.addStyles({ textColor: x }), setTimeout(() => {
        n.focus();
      });
    },
    [n, o]
    ...
    (x) => {
      ...
      x === "default" ? n.removeStyles({ backgroundColor: x }) : n.addStyles({ backgroundColor: x }), setTimeout(() => {
        n.focus();
      });
    },
    [i, n]
  ...
  return !H(() => {
    ...
    for (const x of a)
      if (x.content !== void 0)
        return !0;
    return !1;
  }, [i, a, o]) || !n.isEditable ? null : /* @__PURE__ */ r.jsxs(e.Generic.Menu.Root, { children: [
  ...
  const t = C(), n = M(), { url: o, text: i, editLink: a } = e, [c, u] = v(o), [d, s] = v(i);
  T(() => {
    u(o), s(i);
  }, [i, o]);
  const m = S(
    (V) => {
      V.key === "Enter" && (V.preventDefault(), a(c, d));
    },
    [a, c, d]
  ), g = S(
    (V) => u(V.currentTarget.value),
    []
  ), h = S(
...
const ur = () => {
  const e = w(), t = C(), n = M(), o = sr(e), i = D(e), [a, c] = v(e.getSelectedLinkUrl() || ""), [u, d] = v(e.getSelectedText());
  z(() => {
  ...
  return !H(() => {
    ...
    for (const g of i)
      if (g.content === void 0)
        return !1;
    return !0;
  }, [o, i]) || !("link" in e.schema.inlineContentSchema) || !e.isEditable ? null : /* @__PURE__ */ r.jsxs(t.Generic.Popover.Root, { children: [
    ...
    /* @__PURE__ */ r.jsx(
      t.Generic.Popover.Content,
      {
        ...
        children: /* @__PURE__ */ r.jsx(un, { url: a, text: u, editLink: s })
      }
    )
  ] });
}, dr = () => {
  const e = M(), t = C(), n = w(), [o, i] = v(), a = D(n), c = H(() => {
    if (a.length !== 1)
      return;
    const s = a[0];
    if (ae(s, n))
      return i(s.props.caption), s;
  }, [n, a]), u = S(
    (s) => {
    ...
    (s) => i(s.currentTarget.value),
    []
  );
  return !c || ce(c, n) || !n.isEditable ? null : /* @__PURE__ */ r.jsxs(t.Generic.Popover.Root, { children: [
    /* @__PURE__ */ r.jsx(t.Generic.Popover.Trigger, { children: /* @__PURE__ */ r.jsx(
      t.FormattingToolbar.Button,
      {
        className: "bn-button",
  ...
  const t = C(), n = M(), { block: o } = e, i = w(), [a, c] = v(""), u = S(
    (m) => {
    ...
    (m) => {
      m.key === "Enter" && (m.preventDefault(), i.updateBlock(o, {
        props: {
          name: kt(a),
          url: a
        }
  ...
  var g;
  const t = C(), n = M(), { block: o, setLoading: i } = e, a = w(), [c, u] = v(!1);
  T(() => {
    c && setTimeout(() => {
      u(!1);
    }, 3e3);
  ...
  const d = S(
    (h) => {
      if (h === null)
        return;
      async function x(V) {
        if (i(!0), a.uploadFile !== void 0)
          try {
            let B = await a.uploadFile(V);
            typeof B == "string" && (B = {
              props: {
                name: V.name,
                url: B
  ...
  const t = C(), n = M(), o = w(), [i, a] = v(!1), c = e.tabs ?? [
    ...o.uploadFile !== void 0 ? [
      {
        name: n.file_panel.upload.title,
        tabPanel: /* @__PURE__ */ r.jsx(hr, { block: e.block, setLoading: a })
      }
    ] : [],
    {
      name: n.file_panel.embed.title,
      tabPanel: /* @__PURE__ */ r.jsx(mr, { block: e.block })
    }
  ], [u, d] = v(
  ...
  const e = M(), t = C(), n = w(), o = D(n), [i, a] = v(!1);
  T(() => {
    a(!1);
  }, [o]);
  const c = o.length === 1 ? o[0] : void 0;
  return c === void 0 || !ae(c, n) || !n.isEditable ? null : /* @__PURE__ */ r.jsxs(t.Generic.Popover.Root, { opened: i, position: "bottom", children: [
    /* @__PURE__ */ r.jsx(t.Generic.Popover.Trigger, { children: /* @__PURE__ */ r.jsx(
      t.FormattingToolbar.Button,
      {
        className: "bn-button",
    ...
    /* @__PURE__ */ r.jsx(
      t.Generic.Popover.Content,
      {
        ...
        children: /* @__PURE__ */ r.jsx(dn, { block: c })
      }
    )
  ] });
}, pr = {
  ...
  const t = C(), n = M(), o = w(), i = D(o), a = H(() => {
    const s = i[0];
    if (Ae("textAlignment", s, o))
      return s.props.textAlignment;
  }, [o, i]), c = S(
    (s) => {
      o.focus();
      for (const m of i)
        ie("textAlignment", m.type, o) && o.updateBlock(m, {
          props: { textAlignment: s }
        });
    },
    [o, i]
  );
  if (!H(() => !!i.find((s) => "textAlignment" in s.props), [i]) || !o.isEditable)
    return null;
  const d = pr[e.textAlignment];
  return /* @__PURE__ */ r.jsx(
    t.FormattingToolbar.Button,
    {
      className: "bn-button",
  ...
  const t = C(), n = M(), o = w(), i = D(o), [a, c] = v(o.getTextCursorPosition().block), u = H(() => (e.items || vr(n)).filter(
  ...
  }, o), !d || !o.isEditable ? null : /* @__PURE__ */ r.jsx(
...
const kr = () => {
  const e = M(), t = C(), n = w(), o = D(n), i = H(() => {
    ...
    i && i.props.url && (n.focus(), n.resolveFileUrl(i.props.url).then(
      (c) => window.open(fn(c, window.location.href))
    ));
  }, [n, i]);
  return !i || ce(i, n) ? null : /* @__PURE__ */ r.jsx(
    t.FormattingToolbar.Button,
    {
      className: "bn-button",
  ...
  return !i || ce(i, n) || !n.isEditable ? null : /* @__PURE__ */ r.jsx(
    t.FormattingToolbar.Button,
    {
      className: "bn-button",
  ...
  /* @__PURE__ */ r.jsx(xr, { items: e }, "blockTypeSelect"),
  /* @__PURE__ */ r.jsx(dr, {}, "fileCaptionButton"),
  /* @__PURE__ */ r.jsx(br, {}, "replaceFileButton"),
  /* @__PURE__ */ r.jsx(Cr, {}, "fileRenameButton"),
  /* @__PURE__ */ r.jsx(wr, {}, "fileDeleteButton"),
  /* @__PURE__ */ r.jsx(kr, {}, "fileDownloadButton"),
  /* @__PURE__ */ r.jsx(yr, {}, "filePreviewButton"),
  /* @__PURE__ */ r.jsx(he, { basicTextStyle: "bold" }, "boldStyleButton"),
  /* @__PURE__ */ r.jsx(he, { basicTextStyle: "italic" }, "italicStyleButton"),
  /* @__PURE__ */ r.jsx(
    he,
    {
  ...
  /* @__PURE__ */ r.jsx(he, { basicTextStyle: "strike" }, "strikeStyleButton"),
  ...
  /* @__PURE__ */ r.jsx(cr, {}, "colorStyleButton"),
  /* @__PURE__ */ r.jsx(fr, {}, "nestBlockButton"),
  /* @__PURE__ */ r.jsx(gr, {}, "unnestBlockButton"),
  /* @__PURE__ */ r.jsx(ur, {}, "createLinkButton")
], Hr = (e) => {
  const t = C();
  return /* @__PURE__ */ r.jsx(
    t.FormattingToolbar.Root,
    {
      ...
      children: e.children || jr(e.blockTypeSelectItems)
    }
  );
}, Tt = (e) => {
  switch (e) {
  ...
  const t = pe(null), n = w(), [o, i] = v(
    () => {
      const h = n.getTextCursorPosition().block;
      return "textAlignment" in h.props ? Tt(
  ...
  ), { isMounted: c, ref: u, style: d, getFloatingProps: s } = Q(
  ...
  const g = e.formattingToolbar || Hr;
  return /* @__PURE__ */ r.jsx("div", { ref: m, style: d, ...s(), children: /* @__PURE__ */ r.jsx(g, {}) });
}, Mr = (e) => {
  const t = C(), n = M();
  return /* @__PURE__ */ r.jsx(
  ...
  return /* @__PURE__ */ r.jsx(
    t.LinkToolbar.Button,
    {
      ...
      isSelected: !1,
      onClick: () => {
        window.open(fn(e.url, window.location.href), "_blank");
      },
      icon: /* @__PURE__ */ r.jsx(rr, {})
    }
  );
}, Vr = (e) => {
  const t = C();
  return e.children ? /* @__PURE__ */ r.jsx(t.LinkToolbar.Root, { className: "bn-toolbar bn-link-toolbar", children: e.children }) : /* @__PURE__ */ r.jsxs(
    t.LinkToolbar.Root,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ r.jsx(Er, { url: e.url }),
        /* @__PURE__ */ r.jsx(Mr, { deleteLink: e.deleteLink })
      ]
    }
  );
}, Tr = (e) => {
  ...
  ), { isMounted: i, ref: a, style: c, getFloatingProps: u } = Q(
  ...
  if (!i || !o)
    return null;
  const { show: d, referencePos: s, ...m } = o, g = e.linkToolbar || Vr;
  return /* @__PURE__ */ r.jsx("div", { ref: a, style: c, ...u(), children: /* @__PURE__ */ r.jsx(g, { ...m, ...n }) });
}, Lr = (e) => {
  const t = w();
  if (!t.filePanel)
    throw new Error(
  ...
  ), { isMounted: o, ref: i, style: a, getFloatingProps: c } = Q(
  ...
  if (!o || !n)
    return null;
  const { show: u, referencePos: d, ...s } = n, m = e.filePanel || dn;
  return /* @__PURE__ */ r.jsx("div", { ref: i, style: a, ...c(), children: /* @__PURE__ */ r.jsx(m, { ...s }) });
};
function Rr(e) {
...
const Pr = (e) => {
  const t = C(), n = w();
  return !ie("textColor", e.block.type, n) && !ie("backgroundColor", e.block.type, n) ? null : /* @__PURE__ */ r.jsxs(t.Generic.Menu.Root, { position: "right", sub: !0, children: [
  ...
  return /* @__PURE__ */ r.jsx(
    t.Generic.Menu.Dropdown,
    {
      ...
      children: e.children || /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
        /* @__PURE__ */ r.jsx(Fr, { ...e, children: n.drag_handle.delete_menuitem }),
        /* @__PURE__ */ r.jsx(Pr, { ...e, children: n.drag_handle.colors_menuitem })
      ] })
    }
  );
}, Ir = (e) => {
  const t = C(), n = M(), o = e.dragHandleMenu || Or;
  return /* @__PURE__ */ r.jsxs(
    t.Generic.Menu.Root,
    {
      onOpenChange: (i) => {
        i ? e.freezeMenu() : (e.unfreezeMenu(), e.editor.focus());
      },
      position: "left",
      children: [
        /* @__PURE__ */ r.jsx(t.Generic.Menu.Trigger, { children: /* @__PURE__ */ r.jsx(
          t.SideMenu.Button,
          {
            ...
            className: "bn-button",
            icon: /* @__PURE__ */ r.jsx(gn, { size: 24, "data-test": "dragHandle" })
          }
        ) }),
  ...
  return /* @__PURE__ */ r.jsx(t.SideMenu.Root, { className: "bn-side-menu", ...i, children: e.children || /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
    /* @__PURE__ */ r.jsx(Br, { addBlock: n }),
    /* @__PURE__ */ r.jsx(Ir, { ...o })
  ] }) });
}, Dr = (e) => {
  const t = w(), n = {
  ...
  if (!i || !o)
    return null;
  const { show: d, referencePos: s, ...m } = o, g = e.sideMenu || Nr;
  return /* @__PURE__ */ r.jsx("div", { ref: a, style: c, ...u(), children: /* @__PURE__ */ r.jsx(g, { ...m, ...n, editor: t }) });
};
function Ar(e) {
  const t = C(), n = M(), { items: o, loadingState: i, selectedIndex: a, onItemClick: c } = e, u = i === "loading-initial" || i === "loading" ? /* @__PURE__ */ r.jsx(t.SuggestionMenu.Loader, { className: "bn-suggestion-menu-loader", children: n.suggestion_menu.loading }) : null, d = H(() => {
    let s;
    const m = [];
  ...
  return /* @__PURE__ */ r.jsxs(
    t.SuggestionMenu.Root,
    {
      ...
      children: [
        d,
        d.length === 0 && (e.loadingState === "loading" || e.loadingState === "loaded") && /* @__PURE__ */ r.jsx(
...
function mn(e, t, n, o = 3) {
  const i = pe(0);
  T(() => {
    t !== void 0 && (e.length > 0 ? i.current = t.length : t.length - i.current > o && n());
  }, [n, o, e.length, t]);
}
function hn(e, t) {
  const [n, o] = v([]), [i, a] = v(!1), c = pe(), u = pe();
  return T(() => {
    const d = e;
    c.current = e, a(!0), t(e).then((s) => {
      c.current === d && (o(s), a(!1), u.current = d);
    });
  }, [e, t]), {
    items: n || [],
    ...
    // hook in other hooks.
    usedQuery: u.current,
    loadingState: u.current === void 0 ? "loading-initial" : i ? "loading" : "loaded"
  };
}
function Zr(e, t, n, o) {
  const [i, a] = v(0);
  return T(() => {
    const c = (u) => u.key === "ArrowUp" ? (u.preventDefault(), n.length && a((i - 1 + n.length) % n.length), !0) : u.key === "ArrowDown" ? (u.preventDefault(), n.length && a((i + 1) % n.length), !0) : u.key === "Enter" && !u.isComposing ? (u.preventDefault(), n.length && (o == null || o(n[i])), !0) : !1;
...
function Ur(e) {
  const n = W().setContentEditableProps, o = w(), {
    getItems: i,
    ...
    [s, d, u]
  ), { items: g, usedQuery: h, loadingState: x } = hn(
    c,
    i
  );
  mn(g, h, d);
  const { selectedIndex: V } = Zr(
    o,
    c,
    g,
    m
...
function Gr(e) {
  const t = w(), {
    ...
    [t.suggestionMenus, n]
  ), g = Y(m), { isMounted: h, ref: x, style: V, getFloatingProps: B } = Q(
  ...
  return !h || !g || !(g != null && g.ignoreQueryLength) && i && (g.query.startsWith(" ") || g.query.length < i) ? null : /* @__PURE__ */ r.jsx("div", { ref: x, style: V, ...B(), children: /* @__PURE__ */ r.jsx(
    Ur,
    {
      query: g.query,
      ...
      getItems: d,
      suggestionMenuComponent: o || Ar,
      onItemClick: u
    }
  ) });
}
async function $r(e, t) {
  return (await eo(e, t)).map(
    ({ id: n, onItemClick: o }) => ({
      id: n,
      onItemClick: o,
      icon: n
...
function qr(e) {
  const t = C(), n = M(), { items: o, loadingState: i, selectedIndex: a, onItemClick: c, columns: u } = e, d = i === "loading-initial" || i === "loading" ? /* @__PURE__ */ r.jsx(
  ...
  return /* @__PURE__ */ r.jsxs(
    t.GridSuggestionMenu.Root,
    {
      ...
      children: [
        d,
        s,
        s.length === 0 && e.loadingState === "loaded" && /* @__PURE__ */ r.jsx(
...
function Yr(e, t, n, o, i) {
  const [a, c] = v(0), u = o !== void 0 && o > 1;
  return T(() => {
    ...
    ), !0) : s.key === "ArrowDown" ? (s.preventDefault(), n.length && c((a + o) % n.length), !0) : s.key === "Enter" && !s.isComposing ? (s.preventDefault(), n.length && (i == null || i(n[a])), !0) : !1);
    return e.domElement.addEventListener(
      "keydown",
      d,
      !0
...
function Kr(e) {
  const n = W().setContentEditableProps, o = w(), {
    ...
    [s, d, u]
  ), { items: h, usedQuery: x, loadingState: V } = hn(
    c,
    i
  );
  mn(h, x, d);
  const { selectedIndex: B } = Yr(
    o,
    c,
    h,
    m,
...
function Xr(e) {
  const t = w(), {
    ...
    (_) => t.suggestionMenus.onUpdate(n, _),
    [t.suggestionMenus, n]
  ), h = Y(g), { isMounted: x, ref: V, style: B, getFloatingProps: L } = Q(
    ...
    2e3,
    {
      ...
      middleware: [
        ...
        le(),
        At({
          apply({ availableHeight: _, elements: F }) {
      ...
      onOpenChange(_) {
        _ || t.suggestionMenus.closeMenu();
      }
    }
  );
  return !x || !h || !(h != null && h.ignoreQueryLength) && a && (h.query.startsWith(" ") || h.query.length < a) ? null : /* @__PURE__ */ r.jsx("div", { ref: V, style: B, ...L(), children: /* @__PURE__ */ r.jsx(
    Kr,
    {
      query: h.query,
...
const Jr = (e) => {
  ...
  return /* @__PURE__ */ r.jsx(
    ...
    {
      onClick: () => {
        const i = e.block.content.rows[e.index].cells.map(
          () => []
...
}, Lt = (e) => e.orientation === "row" ? /* @__PURE__ */ r.jsx(Jr, { ...e, side: e.side }) : /* @__PURE__ */ r.jsx(Qr, { ...e, side: e.side }), ei = (e) => {
  const t = C(), n = M(), o = w();
  return /* @__PURE__ */ r.jsx(
    t.Generic.Menu.Item,
    {
...
}, ni = (e) => e.orientation === "row" ? /* @__PURE__ */ r.jsx(ei, { ...e }) : /* @__PURE__ */ r.jsx(ti, { ...e }), oi = (e) => {
  const t = C();
  ...
  const t = C(), [n, o] = v(!1), i = e.tableHandleMenu || oi;
  return /* @__PURE__ */ r.jsxs(
    t.Generic.Menu.Root,
    {
      onOpenChange: (a) => {
      ...
      children: [
        /* @__PURE__ */ r.jsx(t.Generic.Menu.Trigger, { children: /* @__PURE__ */ r.jsx(
          t.TableHandle.Root,
          {
            ...
            children: e.children || /* @__PURE__ */ r.jsx(gn, { size: 24, "data-test": "tableHandle" })
          }
        ) }),
        /* @__PURE__ */ r.jsx(
          i,
...
function Rt(e, t, n, o, i) {
  const { refs: a, update: c, context: u, floatingStyles: d } = Nt({
    open: t,
    placement: e === "row" ? "left" : "top",
    middleware: [J(e === "row" ? -10 : -12)]
  }), { isMounted: s, styles: m } = Dt(u);
  return T(() => {
    c();
  }, [n, o, c]), T(() => {
    n === null || o === null || a.setReference({
      getBoundingClientRect: () => (e === "row" ? ii : li)(n, o, i)
    });
  }, [i, e, n, o, a]), H(
    () => ({
      isMounted: s,
...
const ci = (e) => {
  ...
  const n = {
    ...
    (x = o == null ? void 0 : o.draggingState) == null ? void 0 : x.mousePos
  ]), { rowHandle: a, colHandle: c } = ai(
    (o == null ? void 0 : o.show) || !1,
  ...
  if (!a.isMounted || !c.isMounted || !o)
    return null;
  const g = e.tableHandle || ri;
  return /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
    !u && /* @__PURE__ */ r.jsx("div", { ref: a.ref, style: a.style, children: /* @__PURE__ */ r.jsx(
      g,
      {
        editor: t,
        orientation: "row",
    ...
    !s && /* @__PURE__ */ r.jsx("div", { ref: c.ref, style: c.style, children: /* @__PURE__ */ r.jsx(
      g,
      {
        editor: t,
        orientation: "column",
...
function si(e) {
  ...
  return /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
    e.formattingToolbar !== !1 && /* @__PURE__ */ r.jsx(Sr, {}),
    e.linkToolbar !== !1 && /* @__PURE__ */ r.jsx(Tr, {}),
    e.slashMenu !== !1 && /* @__PURE__ */ r.jsx(Gr, { triggerCharacter: "/" }),
    e.emojiPicker !== !1 && /* @__PURE__ */ r.jsx(
      Xr,
      {
        triggerCharacter: ":",
        columns: 10,
    ...
    e.sideMenu !== !1 && /* @__PURE__ */ r.jsx(Dr, {}),
    t.filePanel && e.filePanel !== !1 && /* @__PURE__ */ r.jsx(Lr, {}),
    t.tableHandles && e.tableHandles !== !1 && /* @__PURE__ */ r.jsx(ci, {})
  ] });
}
const ui = () => {
  const e = H(
    ...
    []
  ), n = e == null ? void 0 : e.matches, o = t == null ? void 0 : t.matches, [i, a] = v(n ? "dark" : o ? "light" : "no-preference");
  return T(() => {
...
const gi = Gn((e, t) => {
  ...
  return $n(
    ...
    () => (i, a) => {
      Gt(() => {
        o({ node: i, container: a });
      }), o(void 0);
    },
    []
  ), /* @__PURE__ */ r.jsx(r.Fragment, { children: n && zt(n.node, n.container) });
}), Bt = () => {
};
function mi(e, t) {
  const {
    ...
    tableHandles: B,
    ...L
  } = e, [_, F] = v(), G = W(), He = ui(), Se = (G == null ? void 0 : G.colorSchemePreference) || He, se = i || (Se === "dark" ? "dark" : "light");
  Ge(d || Bt, n), $e(u || Bt, n), T(() => {
    n.isEditable = c !== !1;
  }, [c, n]);
  const Me = H(() => /* @__PURE__ */ r.jsxs(r.Fragment, { children: [
    a,
    /* @__PURE__ */ r.jsx(
      si,
      {
    ...
    ...G,
    editor: n,
    setContentEditableProps: F
  }), [G, n]), ue = S(
    (Ee) => {
      n.elementRenderer = Ee;
    },
    [n]
  );
  return /* @__PURE__ */ r.jsxs(Kt.Provider, { value: _e, children: [
    /* @__PURE__ */ r.jsx(gi, { ref: ue }),
    !n.headless && /* @__PURE__ */ r.jsx(fi, { editor: n, children: /* @__PURE__ */ r.jsxs(
      "div",
      {
        className: ze(
          "bn-container",
...
const Ii = U.forwardRef(mi);
var We, be = So;
if (process.env.NODE_ENV === "production")
  We = be.createRoot, be.hydrateRoot;
else {
...
function Ce(e, t) {
  ...
  if (t != null && t.elementRenderer ? t.elementRenderer(
    ...
    i.render(e((d) => n = d || void 0));
  })), !o.childElementCount)
    return console.warn("ReactInlineContentSpec: renderHTML() failed"), {
      dom: document.createElement("span")
    };
  n == null || n.setAttribute("data-tmp-find", "true");
  const a = o.cloneNode(!0), c = a.firstElementChild, u = a.querySelector(
    "[data-tmp-find]"
  );
  return u == null || u.removeAttribute("data-tmp-find"), i == null || i.unmount(), {
    dom: c,
    contentDOM: u || void 0
  };
}
      ...
      $t,
      {
        ...
        ...Object.fromEntries(
          Object.entries(e.blockProps).filter(
            ([n, o]) => !to.includes(n) && o !== e.propSchema[n].default
          ).map(([n, o]) => [Zt(n), o])
        ),
...
function ye(e, t) {
  const n = Ut({
    ...
    renderHTML({ HTMLAttributes: o }) {
      ...
      return i.setAttribute("data-tmp-placeholder", "true"), oo(
        {
          dom: i
        },
        e.type,
    ...
    addNodeView() {
      return (o) => {
        const i = qt(
          (a) => {
            var g;
            const c = this.options.editor, u = ro(
              a.getPos,
              c,
              this.editor,
              e.type
            ), d = ((g = this.options.domAttributes) == null ? void 0 : g.blockContent) || {}, s = Yt({}).ref, m = t.render;
            return /* @__PURE__ */ r.jsx(
              De,
              {
                blockType: u.type,
        ...
        return e.isSelectable === !1 && io(i, this.editor), i;
      };
    }
  });
  return lo(e, {
    ...
    toInternalHTML: (o, i) => {
      var d, s;
      const a = ((d = n.options.domAttributes) == null ? void 0 : d.blockContent) || {}, c = t.render, u = Ce(
        (m) => /* @__PURE__ */ r.jsx(
          De,
          {
            blockType: o.type,
    ...
    toExternalHTML: (o, i) => {
      var d, s;
      const a = ((d = n.options.domAttributes) == null ? void 0 : d.blockContent) || {}, c = t.toExternalHTML || t.render, u = Ce((m) => /* @__PURE__ */ r.jsx(
        De,
        {
          blockType: o.type,
          blockProps: o.props,
...
function hi(e) {
  const t = w();
  T(() => t.onUploadStart(e), [e, t]);
}
function bi(e) {
  const t = w();
  T(() => t.onUploadEnd(e), [e, t]);
}
function pi(e) {
  const [t, n] = v(!1);
  return hi((o) => {
...
const we = (e) => pi(e.block.id) ? /* @__PURE__ */ r.jsx("div", { className: "bn-file-loading-preview", children: "Loading..." }) : /* @__PURE__ */ r.jsx("div", { className: "bn-file-block-content-wrapper", children: e.block.props.url === "" ? /* @__PURE__ */ r.jsx(vi, { ...e }) : e.block.props.showPreview === !1 ? /* @__PURE__ */ r.jsx(Ft, { block: e.block, editor: e.editor, children: /* @__PURE__ */ r.jsx(
  bn,
  {
    block: e.block,
    editor: e.editor
  }
) }) : /* @__PURE__ */ r.jsx(Ft, { block: e.block, editor: e.editor, children: e.children }) }), bn = (e) => /* @__PURE__ */ r.jsxs(
  "div",
  {
    ...
    draggable: !1,
    children: [
      /* @__PURE__ */ r.jsx("div", { className: "bn-file-default-preview-icon", children: /* @__PURE__ */ r.jsx(qe, { size: 24 }) }),
      /* @__PURE__ */ r.jsx("p", { className: "bn-file-default-preview-name", children: e.block.props.name })
    ]
  }
), Ft = (e) => /* @__PURE__ */ r.jsxs("div", { className: "bn-file-and-caption-wrapper", children: [
  e.children,
  ...
  return /* @__PURE__ */ r.jsxs(
    "div",
    {
      ...
      onClick: o,
      children: [
        /* @__PURE__ */ r.jsx("div", { className: "bn-add-file-button-icon", children: e.buttonIcon || /* @__PURE__ */ r.jsx(qe, { size: 24 }) }),
        /* @__PURE__ */ r.jsx("div", { className: "bn-add-file-button-text", children: e.buttonText || t.file_blocks.file.add_button_text })
      ]
    }
  );
}, je = (e) => /* @__PURE__ */ r.jsxs("div", { children: [
  e.children,
  /* @__PURE__ */ r.jsx("p", { children: e.caption })
] }), Ke = (e) => /* @__PURE__ */ r.jsxs("figure", { children: [
  e.children,
  /* @__PURE__ */ r.jsx("figcaption", { children: e.caption })
] }), pn = (e) => {
  const [t, n] = v(!1), [o, i] = v(void 0);
  T(() => {
    const s = (g) => {
      let h;
      ...
      const x = 64;
      h < x ? e.setWidth(x) : h > e.editor.domElement.firstElementChild.clientWidth ? e.setWidth(e.editor.domElement.firstElementChild.clientWidth) : e.setWidth(h);
    }, m = () => {
      i(void 0), e.editor.updateBlock(e.block, {
        props: {
...
const xi = (e) => {
  ...
  return e.block.props.caption ? e.block.props.showPreview ? /* @__PURE__ */ r.jsx(Ke, { caption: e.block.props.caption, children: t }) : /* @__PURE__ */ r.jsx(je, { caption: e.block.props.caption, children: t }) : t;
}, ki = (e) => /* @__PURE__ */ r.jsx(
  we,
  {
    ...e,
    buttonText: e.editor.dictionary.file_blocks.audio.add_button_text,
    buttonIcon: /* @__PURE__ */ r.jsx(cn, { size: 24 }),
    children: /* @__PURE__ */ r.jsx(xi, { block: e.block, editor: e.editor })
  }
), Ni = ye(co, {
  render: ki,
  parse: ao,
  ...
  return e.block.props.caption ? /* @__PURE__ */ r.jsx(je, { caption: e.block.props.caption, children: t }) : t;
}, wi = (e) => /* @__PURE__ */ r.jsx(we, { ...e, children: /* @__PURE__ */ r.jsx(bn, { block: e.block, editor: e.editor }) }), Di = ye(uo, {
  render: wi,
  parse: so,
  toExternalHTML: yi
}), ji = (e) => {
  ...
  ), o = Xe(e.block.props.url);
  return o.loadingState === "loading" ? null : /* @__PURE__ */ r.jsx(pn, { ...e, width: t, setWidth: n, children: /* @__PURE__ */ r.jsx(
    "img",
    {
  ...
  we,
  {
    ...
    buttonIcon: /* @__PURE__ */ r.jsx(an, { size: 24 }),
    children: /* @__PURE__ */ r.jsx(ji, { block: e.block, editor: e.editor })
  }
), Ai = ye(go, {
  render: Si,
  parse: fo,
  ...
  we,
  {
    ...
    buttonIcon: /* @__PURE__ */ r.jsx(tr, { size: 24 }),
    children: /* @__PURE__ */ r.jsx(Mi, { block: e.block, editor: e.editor })
  }
), Zi = ye(ho, {
  render: Ei,
  parse: mo,
...
function Ui(e) {
  ...
  const n = e, [o, i] = v(() => n.getActiveStyles());
  return Ge(() => {
    i(n.getActiveStyles());
  }, n), $e(() => {
    i(n.getActiveStyles());
  ...
  return (
    ...
    /* @__PURE__ */ r.jsx(
      $t,
      {
        ...
        ...Object.fromEntries(
          Object.entries(e.inlineContentProps).filter(([t, n]) => n !== e.propSchema[t].default).map(([t, n]) => [Zt(t), n])
        ),
        children: e.children
      }
    )
...
function Gi(e, t) {
  const n = Ut({
    ...
    renderHTML({ node: o }) {
      const i = this.options.editor, a = yt(
        o,
              ...
              children: /* @__PURE__ */ r.jsx(
                u,
                {
                  ...
                  updateInlineContent: (d) => {
                    ...
                    o._tiptapEditor.view.dispatch(
                      o._tiptapEditor.view.state.tr.replaceWith(
                        a.getPos(),
                        a.getPos() + a.node.nodeSize,
                        s
                      )
                    );
                  }
...
function $i(e, t) {
  const n = Mo.create({
    ...
    renderHTML({ mark: o }) {
      const i = {};
      e.propSchema === "string" && (i.value = o.attrs.stringValue);
      const a = t.render, c = Ce(
        (u) => /* @__PURE__ */ r.jsx(a, { ...i, contentRef: u }),
        void 0
      );
      return jo(
        c,
...
function qi(e, t) {
  const n = e.getBoundingClientRect(), o = t.getBoundingClientRect(), i = n.top < o.top, a = n.bottom > o.bottom;
  return i && a ? "both" : i ? "top" : a ? "bottom" : "none";
}
export {
  Br as AddBlockButton,
  Lt as AddButton,
  Qr as AddColumnButton,
  vi as AddFileButton,
  Jr as AddRowButton,
  ki as AudioBlock,
  xi as AudioPreview,
  Ci as AudioToExternalHTML,
  he as BasicTextStyleButton,
  Pr as BlockColorsItem,
  De as BlockContentWrapper,
  Kt as BlockNoteContext,
  si as BlockNoteDefaultUI,
  Ii as BlockNoteViewRaw,
  xr as BlockTypeSelect,
  cr as ColorStyleButton,
  To as ComponentsContext,
  ur as CreateLinkButton,
  bn as DefaultFilePreview,
  ni as DeleteButton,
  ti as DeleteColumnButton,
  Mr as DeleteLinkButton,
  ei as DeleteRowButton,
  Ir as DragHandleButton,
  Or as DragHandleMenu,
  _r as EditLinkButton,
  un as EditLinkMenuItems,
  mr as EmbedTab,
  Ke as FigureWithCaption,
  Ft as FileAndCaptionWrapper,
  wi as FileBlock,
  we as FileBlockWrapper,
  dr as FileCaptionButton,
  wr as FileDeleteButton,
  kr as FileDownloadButton,
  dn as FilePanel,
  Lr as FilePanelController,
  yr as FilePreviewButton,
  Cr as FileRenameButton,
  br as FileReplaceButton,
  yi as FileToExternalHTML,
  Hr as FormattingToolbar,
  Sr as FormattingToolbarController,
  Xr as GridSuggestionMenuController,
  Kr as GridSuggestionMenuWrapper,
  Si as ImageBlock,
  ji as ImagePreview,
  Hi as ImageToExternalHTML,
  Li as InlineContentWrapper,
  Vr as LinkToolbar,
  Tr as LinkToolbarController,
  je as LinkWithCaption,
  fr as NestBlockButton,
  Er as OpenLinkButton,
  Ni as ReactAudioBlock,
  Di as ReactFileBlock,
  Ai as ReactImageBlock,
  Zi as ReactVideoBlock,
  Fr as RemoveBlockItem,
  pn as ResizeHandlesWrapper,
  Nr as SideMenu,
  Dr as SideMenuController,
  Gr as SuggestionMenuController,
  Ur as SuggestionMenuWrapper,
  ri as TableHandle,
  oi as TableHandleMenu,
  ci as TableHandlesController,
  Ne as TextAlignButton,
  gr as UnnestBlockButton,
  hr as UploadTab,
  Ei as VideoBlock,
  Mi as VideoPreview,
  _i as VideoToExternalHTML,
  vr as blockTypeSelectItems,
  ye as createReactBlockSpec,
  Gi as createReactInlineContentSpec,
  $i as createReactStyleSpec,
  qi as elementOverflow,
  $r as getDefaultReactEmojiPickerItems,
  zr as getDefaultReactSlashMenuItems,
  jr as getFormattingToolbarItems,
  Vo as mergeRefs,
  Ui as useActiveStyles,
  Wi as useBlockNote,
  W as useBlockNoteContext,
  w as useBlockNoteEditor,
  mn as useCloseSuggestionMenuNoItems,
  C as useComponentsContext,
  Vi as useCreateBlockNote,
  M as useDictionary,
  Ge as useEditorChange,
  z as useEditorContentOrSelectionChange,
  zi as useEditorForceUpdate,
  $e as useEditorSelectionChange,
  Yr as useGridSuggestionMenuKeyboardNavigation,
  hn as useLoadSuggestionMenuItems,
  ui as usePrefersColorScheme,
  Xe as useResolveUrl,
  D as useSelectedBlocks,
  Zr as useSuggestionMenuKeyboardNavigation,
  ai as useTableHandlesPositioning
};
